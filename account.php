<?php
  ...
  $isAdmin = $_SESSION['user']->getRole();
    ...
    $data = $_SESSION['user']->getUserData($_SESSION['user']->username);

    $row = mysqli_fetch_assoc($data);


    if (isset($_POST['updatepass'])) {
        if ($_POST['passbaru']!=$_POST['passbaru2'] or $_POST['passlama']!=$_SESSION['password']) {
            echo "
                <script>
                  alert('Password Not Same or Wrong');
                </script>
              ";
        }else {
            $_SESSION['user']->updatePassword($_SESSION['user']->username,sha1($_POST['passlama']),sha1($_POST['passbaru']));
        }
    }
  ...
  if( isset($_POST["savechanges"]) ) {
    $_SESSION['user']->updateDataUser($_POST['idpegawai'],$_POST['noidentitas'],$_POST['nama'],$_POST['kelamin'],$_POST['tempat'],$_POST['tgl'],$_POST['pendidikan'],$_POST['almamater'],$_POST['alamat'],$_POST['domisili'],$_POST['tlp'],$_POST['email']);
  }
?>
        ...
        <div class="col ">
            ...
            <form method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default">Divisi</span>
                            </div>
                            <input type="text" class="form-control" name="divisi" value="<?=$row['nama_divisi']?>" aria-label="Default" aria-describedby="inputGroup-sizing-default" readonly>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="jabatan" value="<?=$row['jabatan']?>" aria-label="Default" aria-describedby="inputGroup-sizing-default" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group mb-4">
                    ...
                    <input type="text" class="form-control" name="status" value="<?=$row['status']?>"  aria-label="Default" aria-describedby="inputGroup-sizing-default" readonly>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <button type="submit" name="savechanges" onClick="javascript: return confirm('Please confirm deletion');" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                            Save Changes
                        </button>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="passlama" class="form-control" id="exampleFormControlInput1" placeholder="Password Lama" >
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Password Baru</label>
                    <input type="password" name="passbaru" class="form-control" id="exampleFormControlInput1" placeholder="Password Baru" >
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Password baru</label>
                    <input type="password" name="passbaru2" class="form-control" id="exampleFormControlInput1" placeholder="Password Baru">
                </div>
                <button type="submit" name="updatepass" class="btn btn-primary">Save changes</button>
                </form>
